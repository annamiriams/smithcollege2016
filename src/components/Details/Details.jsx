            ...
            <div className="details-container">
                ...
                <div className="detail-card">
                    ...
                    <table className="cost-table">
                        <tbody>
                            <tr>
                                <td>Coverage of housing</td>
                                <td>$160 value</td>
                            </tr>
                            <tr>
                                <td>Coverage of meals</td>
                                <td>$168 - $214 value</td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div className="detail-card">
                    ...
                    <p>There will be many events taking place on campus throughout the weekend. Below are class-specific events that we want to highlight. You will receive additional details about the weekend schedule as we get closer to reunion.</p>

                    <p>Arrive as early as Thursday evening (May 14) and swing by our class headquarters to pick up your Class of 2016 merch.</p>
